...
class Proposals(models.Model):
    ...
    locked_time = models.DateTimeField(help_text='提案时间', null=True)
    period = models.IntegerField(help_text='等待时间，单位为秒', null=True)
    likes = models.IntegerField(help_text='赞同数', null=True)
    votes = models.IntegerField(help_text='投票数', null=True)
